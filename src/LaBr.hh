...
namespace FDSi {
  ...
  public:
    ...
    LaBrConf() : conf_name("uninitialized") {};
    LaBrConf(std::string na, std::string conffile);
  ...
  public:
    ...
    LaBrHit hits[MAX_HITS];
    Gamma gammas[MAX_GAMMAS];

    LaBrArray() {};
    LaBrArray(std::string na, std::string conffile) : conf(na, conffile) {};
